    ...
    <div>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          {/* features section */}
          <h2 className="text-3xl font-bold tracking-wider text-center mb-12">Powerful Features for your Career Growth </h2>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-muted/50">
        <div className="container mx-auto px-4 md:px-6">
        <h2 className="text-3xl font-bold tracking-wide text-center mb-12">
          What Our Users Say
        </h2>
