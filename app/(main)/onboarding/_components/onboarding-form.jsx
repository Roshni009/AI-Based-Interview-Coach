    ...
    <Card className="w-full max-w-lg mt-10 mx-2">
      ...
      <CardContent>
          ...
          <div className="space-y-3">
            ...
            <Select 
              ...
              <SelectLabel>Industries</SelectLabel>
                {industries.map((indx) => {
                return (
                <SelectItem value={indx.id} key={indx.id}>
                  {indx.name}
                  </SelectItem>
                );  
            })}
          ...
          { watchIndustry && (
            ...
            <Select 
              ...
              <SelectGroup>
                ...
                {selectIndustry?.subIndustries.map((indx) => {
                return (
                <SelectItem value={indx} key={indx}>
                  {indx}
                  </SelectItem>
                );  
            })}
        ...
        <div className="space-y-3">
            ...
            <p className='text-sm text-muted-foreground'>Please Separate multiple skills with commas</p>
         {errors.skills && (
